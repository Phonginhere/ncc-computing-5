...
try {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $update = $mysqli->prepare("DELETE FROM skill WHERE skill_id = ?");
        $update->bind_param('i', $id);
        $update->execute();
        header("Location: skill.php?success=Your skill info has been deleted successfully");
    }
} catch (Exception $e) {
}
?>
                    ...
                    <div class="container">
                        ...
                        <table class="table table-bordered table-striped" id="sortable">
                            ...
                            <tbody id="tb">
                                ...
                                $sql = "SELECT s.skill_id, s.skill_name, s.skill_progress 
                FROM skill as s
                ...
                ORDER BY skill_name ASC ";
                                ...
                                if ($result_we->num_rows > 0) {
                                    while ($val  =   $result_we->fetch_assoc()) { ?>
                                        <tr>
                                            <td align="center"><?php echo $val['skill_name']; ?></td>
                                            <td align="center"><?php echo $val['skill_progress']; ?></td>
                                            <td class="text-center">
                                                <a id="editdata" class="btn btn-primary btn-sm rounded-0 py-0 edit_data noneditable" href="update_skill.php?skill_id=<?php echo $val['skill_id'] ?>">Edit</a>
                                                <?php $value = $val['skill_id'];
                                                echo $val['skill_id']; ?>
                                                <form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>"><input type="hidden" name="skill_id" value="<?php echo $value ?>">
                          ...
                          <i class="fa fa-fw fa-plus-circle"></i> Delete</a> -->
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="6">
                                        <a href="./insert_skill.php" class="btn btn-success" id="addmore"><i class="fa fa-fw fa-plus-circle"></i> Add More</a>
                                    </td>
                                </tr>
                            </tfoot>
                        </table>
